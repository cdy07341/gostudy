...
func init() {
	...
	proto.RegisterType((*StudentRequest)(nil), "hello.StudentRequest")
	proto.RegisterType((*StudentResponse)(nil), "hello.StudentResponse")
}
...
var fileDescriptor_61ef911816e0a8ce = []byte{
	...
	0xa6, 0x0e, 0xc6, 0x55, 0x52, 0xe1, 0xe2, 0x0b, 0x2e, 0x29, 0x4d, 0x49, 0xcd, 0x2b, 0xc1, 0x67,
	0xa0, 0x2a, 0x17, 0x3f, 0x5c, 0x15, 0xd4, 0x48, 0x2c, 0xca, 0x8c, 0xf6, 0x30, 0x72, 0xb1, 0x82,
	0x2d, 0x16, 0x32, 0xe7, 0xe2, 0x08, 0x4e, 0xac, 0x84, 0xb0, 0x85, 0xf5, 0x20, 0xde, 0x40, 0x76,
	0xb6, 0x94, 0x08, 0xaa, 0x20, 0xc4, 0x50, 0x25, 0x06, 0x21, 0x3b, 0x2e, 0x5e, 0x9f, 0xfc, 0x92,
	0x62, 0xff, 0xb4, 0xa0, 0xd4, 0x82, 0x9c, 0xcc, 0xd4, 0x62, 0x92, 0x74, 0x1b, 0x30, 0x0a, 0x59,
	0x71, 0xb1, 0xbb, 0xa7, 0x96, 0xf8, 0x64, 0x16, 0x97, 0x08, 0x89, 0x42, 0x15, 0xa1, 0xfa, 0x4f,
	0x4a, 0x0c, 0x5d, 0x18, 0xa6, 0x3b, 0x89, 0x0d, 0x1c, 0xd0, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff,
	0xff, 0x5e, 0xe7, 0x99, 0x38, 0x77, 0x01, 0x00, 0x00,
}
...
type HelloClient interface {
	...
	GetList(ctx context.Context, in *StudentRequest, opts ...grpc.CallOption) (*StudentResponse, error)
}
...
func (c *helloClient) GetList(ctx context.Context, in *StudentRequest, opts ...grpc.CallOption) (*StudentResponse, error) {
	out := new(StudentResponse)
	err := c.cc.Invoke(ctx, "/hello.Hello/GetList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HelloServer interface {
	...
	GetList(context.Context, *StudentRequest) (*StudentResponse, error)
}
...
func (*UnimplementedHelloServer) GetList(ctx context.Context, req *StudentRequest) (*StudentResponse, error) {
...
func _Hello_GetList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StudentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HelloServer).GetList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hello.Hello/GetList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloServer).GetList(ctx, req.(*StudentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Hello_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetList",
			Handler:    _Hello_GetList_Handler,
		},
	},
